                    ...
                    <motion.div className={ "contact-form__success-message" } variants={ fade } initial={ "hidden" } animate={ "show" } exit={ "hidden" }>
                      ...
                      <motion.form className={ "form flow" } onSubmit={ onSubmit } variants={ fade } initial={ "hidden" } animate={ "show" } exit={ "hidden" }>
                          <div className={ "input__group" }>
                              <Input label={ "First Name" } errors={ errors } { ...register( "firstName", { required: t( "First name is required." ) } ) } disabled={ isSubmitting }/>
                              <Input label={ "Last Name" } errors={ errors } { ...register( "lastName", { required: t( "Last name is required." ) } ) } disabled={ isSubmitting }/>
                          </div>
                          <Input label={ "Email" } errors={ errors } disabled={ isSubmitting }
                                 { ...register( "email", {
                          ...
                          />
                          <TextArea label={ "Message" } errors={ errors } { ...register( "message" ) } rows={ 6 } disabled={ isSubmitting }/>
                          { errors.general && <p className={ "input__error" }>{ errors.general.message }</p> }
                          <ReCaptchaTerms/>
                          <Button disabled={ isSubmitting } isLoading={ isSubmitting } look={ "primary" } type={ "submit" } onClick={ () => clearErrors() }>
                              Send message
                          </Button>
